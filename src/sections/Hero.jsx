        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-xl animate-fade-in animation-delay-300">
                Hi, I'm Dhruv Sonagara, currently pursuing Computer
                Science and Engineering at SVNIT Surat.
                <br />
                I build modern web applications using React.js,
                Next.js and continuously explore AI & Machine Learning.
              </p>
            </div>
